...
except ImportError:  # Older PyTorch / Isaac Gym stack (no Replicate in tensor API)
    DeviceMesh = None  # type: ignore[assignment,misc]
    Replicate = None  # type: ignore[assignment,misc]
    Shard = None  # type: ignore[assignment,misc]
    distribute_module = None  # type: ignore[assignment,misc]

    class ParallelStyle:  # minimal stub for class body parsing
        pass
